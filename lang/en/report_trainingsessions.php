...
$string['authoritysign'] = 'Delivery authority';
...
$string['siteelapsed'] = 'Total time spent at site level'; // @DYNAKEY
...
$string['enrolstartdate'] = 'User enrol start date';
$string['enrolstartdate_help'] = 'The most past enrol start date';
$string['enrolenddate'] = 'User enrol end date';
$string['enrolenddate_help'] = 'The latest enrol end date. If empty, enrol has no ending.';
