...
$string['done'] = 'Activités visitées';
...
$string['exthits'] = 'Sessions (Etendu)';
$string['exthitslastweek'] = 'Sessions semaine dern. (Etendu)';
...
$string['from'] = 'Depuis le';
$string['generatecsv'] = 'Exporter en CSV';
$string['generatepdf'] = 'Exporter en PDF';
$string['generatereports'] = 'Générer les rapports';
$string['generatexls'] = 'Exporter en XLS';
...
$string['hits'] = 'Sessions';
$string['hitslastweek'] = 'Sessions semaine dern.';
$string['id'] = 'ID';
...
$string['scoresettingsadvice'] = 'Vous pouvez activer ou désactiver l\'affichage des différentes notes via ce menu, ainsi que modifier leur libelle';
