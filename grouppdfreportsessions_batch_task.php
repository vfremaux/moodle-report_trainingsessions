...
if (!empty($targetusers)) {
    ...
    foreach ($targetusers as $auser) {
        ...
        if ($reportscope == 'allcourses') {
            report_trainingsessions_print_usersessions($pdf, $userid, $y, $from, $to, 0);
        } else {
            report_trainingsessions_print_usersessions($pdf, $userid, $y, $from, $to, $id);
        }
        report_trainingsessions_print_signboxes($pdf, $y, array('student' => true, 'authority' => true));
    }
